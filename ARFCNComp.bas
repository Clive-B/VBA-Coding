...
Sub AddARFCNValues()
    ...
    ' Set the worksheet
    Set ws = ThisWorkbook.Sheets("UMTS_3GIDLE_MultiMetric_5")
    networkName = ResolveCoverageNetwork()
    
    If networkName = "AT" Then
    ' Your values array
    values = Array("10637", "10662", "10737", "10762", 3088, "10562", "3043", "10587", "10612", "2987", "3000", "6350")
    
    ElseIf networkName = "MTN" Then
    values = Array("10812", "3082", "10837", "10787")
    
    ElseIf networkName = "TELECEL" Then
    values = Array("10562", "3043", "10587", "10612", "2987", "3000", "6350")

    Else
    MsgBox "Cannot determine network for ARFCN filtering.", vbExclamation, "ARFCN Values"
    Exit Sub
