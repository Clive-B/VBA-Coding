Attribute VB_Name = "ThreeGDataSingleFileProcessing"
Option Explicit
...
Private Const SINGLE_3G_DATA_FORM_NAME As String = "ThreeGDataUserForm"
...
Private Function BuildSingleDataKey(ByVal fileNameText As String) As String
    BuildSingleDataKey = UCase$(ExtractDateFromDataFile(fileNameText) & "|" & _
                                ExtractTownFromDataFile(fileNameText) & "|" & _
                                ExtractLocationFromDataFile(fileNameText))
End Function
